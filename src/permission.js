...
// import { countUsageLog } from '@/api/usageLog'
        ...
        store.dispatch('GetInfo')
          .then(res => {
            ...
            store.dispatch('GenerateRoutes', { roles }).then(() => {
              ...
              if (to.path === '/education' || to.path === '/base' || to.path === '/family' || to.path === '/work' || to.path === 'employee' || to.path === 'place'  || to.path === 'person' || to.path === 'money' ){
                next({ path: '/resource/employee', replace: true })
              } else {
                if (to.path === redirect) {
